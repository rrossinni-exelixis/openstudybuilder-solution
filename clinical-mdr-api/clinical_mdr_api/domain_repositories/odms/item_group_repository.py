...
toString(odm_value.is_reference_data) AS is_reference_data,
odm_value.sas_dataset_name AS sas_dataset_name,
odm_value.origin AS origin,
odm_value.purpose AS purpose,
...
[(odm_value)-[:HAS_SDTM_DOMAIN]->(:CTTermContext)-[:HAS_SELECTED_TERM]->
...
[(odm_value)-[iref:ITEM_REF]->(iv:OdmItemValue)<-[:HAS_VERSION]-(ir:OdmItemRoot) |
