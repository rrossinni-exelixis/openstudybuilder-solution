...
from tests import test_migration_019
...
def test_ct_config_values():
    test_migration_019.test_ct_config_values(migration)


def test_indexes_and_constraints():
    test_migration_019.test_indexes_and_constraints(migration)


def test_remove_odm_data():
    test_migration_019.test_remove_odm_data(migration)


def test_migrate_codelist_ordinal():
    test_migration_019.test_migrate_codelist_ordinal(migration)
