...
from tests import test_migration_021
...
def test_ct_config_values():
    test_migration_021.test_ct_config_values(migration)


def test_indexes_and_constraints():
    test_migration_021.test_indexes_and_constraints(migration)


def test_migrate_odm_nodes_and_relationships():
    test_migration_021.test_migrate_odm_nodes_and_relationships(migration)
